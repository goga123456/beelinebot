...
lang_dict = {'wrong_data': {'Русский 🇷🇺': 'Неверные данные', 'Oʻzbek tili 🇺🇿': 'Notoʻgʻri maʻlumotlar' },
             ...
             'ask_birthday': {'Русский 🇷🇺': 'Дата твоего рождения', 'Oʻzbek tili 🇺🇿': 'Tugʻilgan kun, oy va yilingizni kiriting' },
             'wrong_birthday': {'Русский 🇷🇺': 'Вы ввели неправильную дату!', 'Oʻzbek tili 🇺🇿': 'Siz notoʻgʻri sanani kiritdingiz!' },
             'number': {'Русский 🇷🇺': 'Укажи контактный номер, чтобы мы могли связаться с тобой', 'Oʻzbek tili 🇺🇿': 'Siz bilan bogʻlanishimiz uchun telefon raqamingizni kiriting' },
             ...
             'town_and_districtt': {'Русский 🇷🇺': 'Напиши регион (город) и район', 'Oʻzbek tili 🇺🇿': 'Viloyat (shahar) va tuman nomini yozing' },
             ...
             'education': {'Русский 🇷🇺': 'Укажи уровень образования', 'Oʻzbek tili 🇺🇿': 'Taʻlim darajasini ko‘rsating' },
             ...
             'work':  {'Русский 🇷🇺': 'Есть ли у тебя опыт работы? (неважно официальный или неофициальный)', 'Oʻzbek tili 🇺🇿': 'Siz oldin ishlaganmisiz? (rasmiy yoki norasmiy boʻlishidan qatʻiy nazar)' },
             'work_experience':  {'Русский 🇷🇺': 'Опиши последний опыт работы коротко\n\n- Кем ты работал? \n- В какой организации? \n- Период работы ', 'Oʻzbek tili 🇺🇿': 'Oxirgi ish joyingiz haqida qisqacha maʻlumot bering\n\n- Qaysi lavozimda ishlagansiz? \n- Qaysi tashkilotda? \n- Ishlagan vaqtingiz' },
             ...
             'sendmail': {'Русский 🇷🇺': 'Твоя анкета отправлена на рассмотрение.\n\nПодготовься к телефонному собеседованию\n\nСписок примерных вопросов:\n1. Расскажи о себе\n2. Какими качествами должен обладать сотрудник контакт-центра\n3. Твои ожидания по заработной плате', 'Oʻzbek tili 🇺🇿': 'Sizning maʻlumotlaringiz koʻrib chiqish uchun yuborildi.\n\n Telefon orqali suhbatdan oʻtishga tayyorlaning \n\n Berilishi mumkin boʻlgan savollar: \n1. Oʻzingiz haqingizda gapirib bering.\n2. Aloqa markazi xodimi qanday fazilatlarga ega boʻlishi kerak?\n 3. Kutilayotgan maosh?' },
             'again':  {'Русский 🇷🇺': 'Если хочешь пройти опрос заново нажми на кнопку: "/start" ', 'Oʻzbek tili 🇺🇿': 'Soʻrovnomadan qaytadan oʻtishni istasangiz quyidagi tugmani bosing: "/start"' },
             'checker':  {'Русский 🇷🇺': 'Выбери вариант кнопкой', 'Oʻzbek tili 🇺🇿': 'Tugmani bosib variantni tanlang' },
             ...
             'knopka':  {'Русский 🇷🇺': 'На следующие вопросы ответь выбором одного из вариантов!', 'Oʻzbek tili 🇺🇿': 'Quyidagi savollarga keltirilgan variantlardan birini tanlash orqali javob bering!' },
             ...
             'd/y_not_choosen':  {'Русский 🇷🇺': 'Ты не выбрал день и год', 'Oʻzbek tili 🇺🇿': 'Siz kun va yilni tanlamadingiz' },
             'd/m_not_choosen':  {'Русский 🇷🇺': 'Ты не выбрал день и месяц', 'Oʻzbek tili 🇺🇿': 'Siz kun va oyni tanlamadingiz' },
             'm/y_not_choosen':  {'Русский 🇷🇺': 'Ты не выбрал месяц и год', 'Oʻzbek tili 🇺🇿': 'Siz oy va yilni tanlamadingiz' },
...
def send_email():
    ...
    fp=open('C:\Users\User\Desktop\movarounahr_bot-master\app\example.xlsx','rb')
